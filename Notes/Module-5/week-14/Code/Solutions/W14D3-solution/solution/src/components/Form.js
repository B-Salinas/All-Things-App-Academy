...
function Form(props) {
	...
	const validate = () => {
		console.log("inside my validate functiom");
		...
		if (bio.length > 280) {
			validationErrors.push(
				"Please write a shorter bio (you have " + bio.length + " chars)"
			);
		}
	...
	const onSubmit = (e) => {
		...
		console.log("successful submission, with no errors");
  ...
  let tester = 12;
	...
	// console.log("about to render stuff on the page");
	return (
		<div className="container">
			<h2>User Information</h2>
			{/* <Header prop1="string1" /> */}
			{Header({other: "string" })}
			{/* <h2>
				{(function iife() {
			...
			<form onSubmit={onSubmit}>
				<div className="form-row">
					...
					<input
						...
						type="text"
						onChange={(e) => {
							console.log("this is when I typed a letter");
