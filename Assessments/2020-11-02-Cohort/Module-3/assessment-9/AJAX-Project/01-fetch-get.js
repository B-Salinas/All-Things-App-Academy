...
async function getPeople() {
  ...
  window.addEventListener('DOMContentLoaded', (e) => {
    peopleList = document.getElementByID('people-list-01');
   
    for (people in peopleData) { // I initially used .forEach but peopleData is an object? I could be wrong
      let listItem = document.createAttribute('li');
      listItem.innerHTML = `${people.lastName}, ${people.firstName}`;
